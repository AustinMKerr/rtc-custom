...
export var UncontrolledTreeEnvironment = React.forwardRef(function (props, ref) {
    ...
    return (React.createElement(ControlledTreeEnvironment, __assign({}, props, { ref: ref, viewState: viewState, items: currentItems, onExpandItem: function (item, treeId) {
            ...
            var hasForeignItem, promises, itemsIndices, itemsPriorToInsertion, _loop_1, _i, items_1, item, state_1, newParent, newParentChildren;
            var _a, _b, _c, _d, _e, _f;
            return __generator(this, function (_g) {
                switch (_g.label) {
                    case 0:
                        hasForeignItem = items.some(function (item) {
                            return !Object.values(currentItems).some(function (potentialParent) { var _a, _b; return (_b = (_a = potentialParent === null || potentialParent === void 0 ? void 0 : potentialParent.children) === null || _a === void 0 ? void 0 : _a.includes) === null || _b === void 0 ? void 0 : _b.call(_a, item.index); });
                        });
                        if (hasForeignItem) {
                            (_a = props.onDrop) === null || _a === void 0 ? void 0 : _a.call(props, items, target);
                            return [2 /*return*/];
                        }
                        promises = [];
                        ...
                        _loop_1 = function (item) {
                            ...
                            if (target.targetType === 'between-items') {
                                if (target.parentItem === parent_1.index) {
                                    ...
                                    var isOldItemPriorToNewItem = ((_c = ((_b = newParent.children) !== null && _b !== void 0 ? _b : []).findIndex(function (child) { return child === item.index; })) !== null && _c !== void 0 ? _c : Infinity) < target.childIndex;
                        ...
                        // insert new items
                        if (target.targetType === 'item' || target.targetType === 'root') {
                            promises.push(dataProvider.onChangeItemChildren(target.targetItem, __spreadArray(__spreadArray([], ((_d = currentItems[target.targetItem].children) !== null && _d !== void 0 ? _d : []).filter(function (i) { return !itemsIndices.includes(i); }), true), itemsIndices, true)));
                        }
                        else {
                            newParent = currentItems[target.parentItem];
                            newParentChildren = __spreadArray([], ((_e = newParent.children) !== null && _e !== void 0 ? _e : []), true).filter(function (c) { return !itemsIndices.includes(c); });
                    ...
                    case 1:
                        _g.sent();
                        (_f = props.onDrop) === null || _f === void 0 ? void 0 : _f.call(props, items, target);
                        return [2 /*return*/];
                }
            });
