...
var useControlledTreeEnvironmentProps = function (_a) {
    ...
    var _e = (0, react_1.useState)({}), searchLoading = _e[0], setSearchLoading = _e[1];
    var searchSeqRef = (0, react_1.useRef)({});
    var searchTimerRef = (0, react_1.useRef)({});
    ...
    var runSearch = (0, useStableHandler_1.useStableHandler)(function (treeId, search) {
        var _a, _b;
